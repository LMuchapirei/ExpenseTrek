...
//  ExpenseTrek
//
//  Created by Linval Muchapirei on 13/12/2023.
//

import SwiftUI

struct SwipeActionX: View {
    var body: some View {
        Home()
    }
}
...
struct SwipeAction<Content:View>: View {
    ...
    /// View Unique ID
    let viewId = UUID()
    @State private var isEnabled: Bool = true /// Disabling the interactions while the animation is active
